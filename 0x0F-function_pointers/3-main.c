 ...
 *
 * @argv: A pointer that refers to the character type input from the user.
 * @argc: state how many arguments are of the int type
 *
...
int main(int argc, char *argv[])
{
	...
	/* The input provided by the user should consist of four elements. */
	/* A combination of the file name, the first number, an operator, */
